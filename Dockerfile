...
RUN apk --no-cache add php php-cli php-fpm php-tokenizer php-session php-json php-mbstring php-curl php-pdo php-pdo_mysql mariadb-client php-curl php-xml curl php-xml php-mysqlnd php-mysqli
